	...
	public Busqueda() {
                    ...
                    public void mouseClicked(MouseEvent e){
                        ...
                        if(filaReservas>=0){
                            ...
                            if(confirmar == JOptionPane.YES_OPTION){
                                ...
                                reservaController.removeReserva(Integer.valueOf(valor));
                            ...
                            if(confirmaHuesped == JOptionPane.YES_OPTION){
                                ...
                                huespedController.removeHuesped(Integer.valueOf(valor));
       ...
       private List<Reserva> listarReservas(){
        ...
        private List<Reserva> buscarReserva(){
           return this.reservaController.findReserva(txtBuscar.getText());
       }       
       
       private void visualizarTablaReservas(){
        ...
        private void visualizarTablaReserva(){
            ...
            Optional.ofNullable(modelo.getValueAt(tbReservas.getSelectedRow(), tbReservas.getSelectedColumn()))
                    .ifPresent(fila ->{
                        ...
                        if(tbReservas.getSelectedColumn() == 0){
                            ...
                            this.reservaController.editReserva(fechaEntrada, fechaSalida, valor, formaPago, id);
       ...
       private List<Huesped> buscarHuesped(){
           return this.huespedController.findHuesped(txtBuscar.getText());
       }
       
        private void visualizarTablaHuespedes(){
        ...
        private void visualizarTablaHuesped(){
           List<Huesped> huespedes = buscarHuesped();
           modeloHuesped.setRowCount(0);
           try {
               for(Huesped huesped: huespedes){
                   modeloHuesped.addRow(new Object[]{
        ...
        public void actualizarHuesped(){
            Optional.ofNullable(modeloHuesped.getValueAt(tbHuespedes.getSelectedRow(), tbHuespedes.getSelectedColumn()))
                    .ifPresentOrElse(filaHuesped ->{
                        ...
                        this.huespedController.editHuesped(nombre, apellido, fechaNacimiento, nacionalidad, telefono, id_reserva, id);
                        JOptionPane.showMessageDialog(this, String.format("Registro modificado con exito !"));
                        }

                    },() -> JOptionPane.showInternalMessageDialog(this, "Porfavor, no seas animal"));
