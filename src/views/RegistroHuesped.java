...
public class RegistroHuesped extends JFrame {
	...
	private void guardarHuesped(){
            if(txtFechaN.getDate() != null && !txtNombre.equals("") && !txtApellido.equals("") && !txtTelefono.equals("")){
                ...
                Huesped huesped = new Huesped(txtNombre.getText(), txtApellido.getText(), fechaNacimiento,
                txtNacionalidad.getSelectedItem().toString(), txtTelefono.getText(), numeroReserva);
                
                this.huespedController.addHuesped(huesped);
                
                Exito exito = new Exito();
                exito.setVisible(true);
                dispose();
            }else{
                JOptionPane.showMessageDialog(this, "Rellena todos los días");
            }
        }
